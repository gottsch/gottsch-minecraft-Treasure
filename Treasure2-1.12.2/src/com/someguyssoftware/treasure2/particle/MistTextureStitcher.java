...
public class MistTextureStitcher {
	...
	public void stitcherEventPre(TextureStitchEvent.Pre event) {
		...
		ResourceLocation poisonMistResourceLocation = new ResourceLocation(Treasure.MODID, "particle/poison_mist_particle");
		ResourceLocation poisonMistResourceLocation2 = new ResourceLocation(Treasure.MODID, "particle/poison_mist_particle2");
		ResourceLocation poisonMistResourceLocation3 = new ResourceLocation(Treasure.MODID, "particle/poison_mist_particle3");
		ResourceLocation poisonMistResourceLocation4 = new ResourceLocation(Treasure.MODID, "particle/poison_mist_particle4");
		
		ResourceLocation witherMistResourceLocation = new ResourceLocation(Treasure.MODID, "particle/wither_mist_particle");
		ResourceLocation witherMistResourceLocation2 = new ResourceLocation(Treasure.MODID, "particle/wither_mist_particle2");
		ResourceLocation witherMistResourceLocation3 = new ResourceLocation(Treasure.MODID, "particle/wither_mist_particle3");
		ResourceLocation witherMistResourceLocation4 = new ResourceLocation(Treasure.MODID, "particle/wither_mist_particle4");
