 ...
 *
 */
public class SkullChestGui extends GuiContainer {

	// This is the resource location for the background image for the GUI
	private static final ResourceLocation texture = new ResourceLocation(Treasure.MODID, "textures/gui/container/skull_chest.png");
	 ...
	 * @param tileEntity
	 */
	public SkullChestGui(InventoryPlayer invPlayer, AbstractTreasureChestTileEntity tileEntity) {
		super(new SkullChestContainer(invPlayer, (IInventory) tileEntity.getInventoryProxy()));
