 ...
 *
 */
public class MolluscChestGui extends GuiContainer {

	// This is the resource location for the background image for the GUI
	private static final ResourceLocation texture = new ResourceLocation(Treasure.MODID, "textures/gui/container/mollusc_chest.png");
	...
	public MolluscChestGui(InventoryPlayer invPlayer, AbstractTreasureChestTileEntity tileEntity) {
		super(new MolluscChestContainer(invPlayer, (IInventory) tileEntity.getInventoryProxy()));
