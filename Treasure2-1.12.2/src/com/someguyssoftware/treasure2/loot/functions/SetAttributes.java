 ...
 *
 */
public class SetAttributes extends TreasureLootFunction {
	private final SetAttributes.Modifier[] modifiers;

	public SetAttributes(TreasureLootCondition[] conditionsIn, SetAttributes.Modifier[] modifiersIn) {
		super(conditionsIn);
	...
	public static class Serializer extends TreasureLootFunction.Serializer<SetAttributes> {
		public Serializer() {
		...
		public SetAttributes deserialize(JsonObject object, JsonDeserializationContext deserializationContext, TreasureLootCondition[] conditionsIn) {
