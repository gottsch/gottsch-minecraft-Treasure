 ...
 *
 */
public class EntityHasProperty implements TreasureLootCondition {
	 ...
	 * @param targetIn
	 */
	public EntityHasProperty(EntityProperty[] propertiesIn, TreasureLootContext.EntityTarget targetIn) {
	...
	public static class Serializer extends TreasureLootCondition.Serializer<EntityHasProperty> {
		...
		public EntityHasProperty deserialize(JsonObject json, JsonDeserializationContext context) {
			...
			return new EntityHasProperty(aentityproperty, (TreasureLootContext.EntityTarget) JsonUtils.deserializeClass(json, "entity", context, TreasureLootContext.EntityTarget.class));
		}
	}
}