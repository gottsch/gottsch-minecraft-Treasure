 ...
 *
 */
public class CanopyWellGenerator implements IWellGenerator<GeneratorResult<GeneratorData>> {

	/**
	 * 
	 */
	public CanopyWellGenerator() {
		super();
	}
	...
	public ICoords buildTop(World world, ICoords coords) {
		...
		// pillars
		world.setBlockState(coords.add(-1, 1, -1).toPos(), Blocks.COBBLESTONE_WALL.getDefaultState(), 3);
		world.setBlockState(coords.add(1, 1, -1).toPos(), Blocks.COBBLESTONE_WALL.getDefaultState(), 3);
		world.setBlockState(coords.add(-1, 1, 1).toPos(), Blocks.COBBLESTONE_WALL.getDefaultState(), 3);
		world.setBlockState(coords.add(1, 1, 1).toPos(), Blocks.COBBLESTONE_WALL.getDefaultState(), 3);
		
		world.setBlockState(coords.add(-1, 2, -1).toPos(), Blocks.COBBLESTONE_WALL.getDefaultState(), 3);
		world.setBlockState(coords.add(1, 2, -1).toPos(), Blocks.COBBLESTONE_WALL.getDefaultState(), 3);
		world.setBlockState(coords.add(-1, 2, 1).toPos(), Blocks.COBBLESTONE_WALL.getDefaultState(), 3);
		world.setBlockState(coords.add(1, 2, 1).toPos(), Blocks.COBBLESTONE_WALL.getDefaultState(), 3);
		
		// pillars level 3
		world.setBlockState(coords.add(-1, 3, -1).toPos(), Blocks.COBBLESTONE_WALL.getDefaultState(), 3);
		world.setBlockState(coords.add(0, 3, -1).toPos(), Blocks.COBBLESTONE_WALL.getDefaultState(), 3);
		world.setBlockState(coords.add(1, 3, -1).toPos(), Blocks.COBBLESTONE_WALL.getDefaultState(), 3);
		
		world.setBlockState(coords.add(-1, 3, 0).toPos(), Blocks.COBBLESTONE_WALL.getDefaultState(), 3);
		world.setBlockState(coords.add(0, 3, 0).toPos(), Blocks.COBBLESTONE_WALL.getDefaultState(), 3);
		world.setBlockState(coords.add(1, 3, 0).toPos(), Blocks.COBBLESTONE_WALL.getDefaultState(), 3);
	...
	@Override
	public GeneratorResult generate2(World world, Random random,
