 ...
 *
 */
public class WoodDrawWellGenerator implements IWellGenerator<GeneratorResult<GeneratorData>> {

	/**
	 * 
	 */
	public WoodDrawWellGenerator() {
		super();
	}
...
//		Treasure.logger.debug("Land Coords @ {}", spawnCoords.toShortString());
	...
	public ICoords buildTop(World world, ICoords coords) {
		...
		// wood draw		
		world.setBlockState(coords.add(-1, 1, 0).toPos(), Blocks.OAK_FENCE.getDefaultState(), 3);
		world.setBlockState(coords.add(1, 1, 0).toPos(), Blocks.OAK_FENCE.getDefaultState(), 3);

		world.setBlockState(coords.add(-1, 2, 0).toPos(), Blocks.OAK_FENCE.getDefaultState(), 3);
		world.setBlockState(coords.add(0, 2, 0).toPos(), Blocks.OAK_FENCE.getDefaultState(), 3);
		world.setBlockState(coords.add(1, 2, 0).toPos(), Blocks.OAK_FENCE.getDefaultState(), 3);
