...
public class SpawnWitherTreeCommand extends CommandBase {
	...
	public String getName() {
		return "treasurewithertree";
	}

	@Override
	public String getUsage(ICommandSender var1) {
		return "/treasurewithertree <x> <y> <z>: spawns a Treasure! wither tree at location (x,y,z)";
	}
	...
	public void execute(MinecraftServer server, ICommandSender commandSender, String[] args) {
		...
		try {
			...
			if (player != null) {
    			...
    			gen.generate(world, random, new Coords(x, y, z), Configs.witherTreeConfig);
    		}
		}
		catch(Exception e) {
