...
public class ModelNew extends ModelBase
{
  ...
  public ModelNew()
  {
    ...
    textureHeight = 64;
      ...
      handle1.addBox(1.5F, 1.5F, -4F, 7, 1, 1);
      handle1.setRotationPoint(-6F, 15F, -3F);
      handle1.setTextureSize(64, 32);
      handle1.mirror = true;
      setRotation(handle1, 0F, 0F, 0F);
      handle2 = new ModelRenderer(this, 27, 25);
      handle2.addBox(4.433333F, -3.5F, -4F, 1, 7, 1);
      handle2.setRotationPoint(-6F, 17F, -3F);
