 ...
 * @param <T>
 */
public class VikingChestMimicModel<T extends Entity> extends MimicModel<T> {
...
//				lid.xRot = timeSlice * -0.7854F;
//				topLatch.xRot = timeSlice * -0.2618F;
//				frontLatch.xRot = timeSlice * 3.14159F;
