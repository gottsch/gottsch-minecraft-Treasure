 ...
 */
@OnlyIn(Dist.CLIENT)
public class PirateChestMimicLayer<T extends Entity, M extends PirateChestMimicModel<T>> extends EyesLayer<T, M> {
	...
	public PirateChestMimicLayer(RenderLayerParent<T, M> layer) {
		super(layer);
	}
