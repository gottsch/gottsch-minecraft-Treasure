 ...
 */
package mod.gottsch.forge.treasure2.client.model.entity;// Made with Blockbench 4.9.4
 ...
 *
 */
public class VanillaChestMimicModel<T extends Entity> extends MimicModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Treasure.MODID, "vanilla_chest_mimic"), "main");
