...
@OnlyIn(Dist.CLIENT)
public class CrateChestRenderer extends AbstractChestBlockEntityRenderer {
	public static final ResourceLocation CRATE_CHEST_RENDERER_ATLAS_TEXTURE = new ResourceLocation(Treasure.MODID, "entity/chest/crate_chest");

	
	public CrateChestRenderer(BlockEntityRendererProvider.Context context) {
