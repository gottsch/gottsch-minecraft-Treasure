 ...
 *
 */
public class CauldronChestBlockEntity extends AbstractTreasureChestBlockEntity {
	
	/**
	 * 
	 * @param texture
	 */
	public CauldronChestBlockEntity(BlockPos pos, BlockState state) {
		super(TreasureBlockEntities.CAULDRON_CHEST_BLOCK_ENTITY_TYPE.get(), pos, state);
	}
	...
	public Component getDefaultName() {
		return new TranslatableComponent(LangUtil.screen("cauldron_chest.name"));
	}
