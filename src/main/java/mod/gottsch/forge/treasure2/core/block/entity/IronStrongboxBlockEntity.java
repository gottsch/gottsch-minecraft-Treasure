 ...
 *
 */
public class IronStrongboxBlockEntity extends AbstractTreasureChestBlockEntity {
	...
	public IronStrongboxBlockEntity(BlockPos pos, BlockState state) {
		super(TreasureBlockEntities.IRON_STRONGBOX_BLOCK_ENTITY_TYPE.get(), pos, state);
	}
	...
	public Component getDefaultName() {
		return new TranslatableComponent(LangUtil.screen("iron_strongbox.name"));
	}
