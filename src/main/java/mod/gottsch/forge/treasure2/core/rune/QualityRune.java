...
import mod.gottsch.forge.treasure2.core.charm.cost.QualityRuneCostReducerEvaluator;
...
public class QualityRune extends Rune {
	...
	public boolean isValid(ItemStack itemStack) {		
		return itemStack.getCapability(TreasureCapabilities.CHARMABLE).isPresent(); // && check against Illumination and other specials
	}
