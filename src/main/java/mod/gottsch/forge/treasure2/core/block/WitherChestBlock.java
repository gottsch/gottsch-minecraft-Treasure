...
public class WitherChestBlock extends StandardChestBlock {
	...
	public WitherChestBlock(Class<? extends AbstractTreasureChestBlockEntity> blockEntityClass, LockLayout type, Properties properties) {
		super(blockEntityClass, ChestInventorySize.WITHER.getSize(), type, properties);
	}
