 ...
 */
public class LegendaryChestSubprocessor extends HighTierRarityChestSubprocessor {

    public LegendaryChestSubprocessor() {
    }

    public LegendaryChestSubprocessor(ChestSubprocessorData data) {
        super(data);
    }
    ...
    public List<AbstractTreasureChestBlock> getValidChests(final IRarity rarity) {
        ...
        // add all using a lesser rarity (epic)
