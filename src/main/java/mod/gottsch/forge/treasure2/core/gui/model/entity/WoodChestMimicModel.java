...
//	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Treasure.MODID, "wood_chest_mimic"), "main");
	...
	public WoodChestMimicModel() {
		...
		t_r1.texOffs(0, 35).addBox(-3.0F, 2.5F, 0.6F, 3.0F, 3.0F, 0.0F, 0.0F, false);
		...
		t_r2.texOffs(0, 35).addBox(-3.0F, 2.5F, 0.5F, 3.0F, 3.0F, 0.0F, 0.0F, false);
		...
		t_r3.texOffs(0, 35).addBox(-3.0F, 2.5F, 0.4F, 3.0F, 3.0F, 0.0F, 0.0F, false);
		...
		t_r4.texOffs(0, 35).addBox(-3.0F, 2.5F, 0.5F, 3.0F, 3.0F, 0.0F, 0.0F, false);
		...
		t_r5.texOffs(0, 35).addBox(-3.0F, 2.5F, 0.6F, 3.0F, 3.0F, 0.0F, 0.0F, false);
		...
		t_r6.texOffs(0, 35).addBox(-2.5F, 2.0F, 0.5F, 3.0F, 3.0F, 0.0F, 0.0F, false);
		...
		t_r7.texOffs(0, 35).addBox(-2.5F, 2.0F, 0.0F, 3.0F, 3.0F, 0.0F, 0.0F, false);
		...
		t_r8.texOffs(0, 35).addBox(-2.5F, 2.0F, -0.1F, 3.0F, 3.0F, 0.0F, 0.0F, false);
		...
		t_r9.texOffs(0, 35).addBox(-2.5F, 2.0F, -0.5F, 3.0F, 3.0F, 0.0F, 0.0F, false);

		eye1 = new ModelRenderer(this);
		eye1.setPos(4.5F, -2.1F, -12.1F);
		lid.addChild(eye1);
		eye1.texOffs(0, 25).addBox(-1.5F, 0.0F, -2.0F, 3.0F, 2.0F, 2.0F, 0.0F, false);

		eye2 = new ModelRenderer(this);
		eye2.setPos(-3.5F, -2.1F, -12.1F);
		lid.addChild(eye2);
		eye2.texOffs(0, 25).addBox(-1.5F, 0.0F, -2.0F, 3.0F, 2.0F, 2.0F, 0.0F, true);

		eye3 = new ModelRenderer(this);
		eye3.setPos(0.5F, -3.1F, -12.1F);
		lid.addChild(eye3);
		eye3.texOffs(0, 25).addBox(-1.5F, 0.0F, -2.0F, 3.0F, 2.0F, 2.0F, 0.0F, true);

		ModelRenderer skin1 = new ModelRenderer(this);
		skin1.setPos(6.0F, 2.0F, -4.5F);
		lid.addChild(skin1);
		setRotationAngle(skin1, 0.5236F, 0.0F, 0.0F);
		skin1.texOffs(0, 0).addBox(0.0F, -4.0F, -2.5F, 0.0F, 6.0F, 6.0F, 0.0F, false);

		ModelRenderer skin2 = new ModelRenderer(this);
		skin2.setPos(-6.0F, 2.0F, -4.5F);
		lid.addChild(skin2);
		setRotationAngle(skin2, 0.5236F, 0.0F, 0.0F);
		skin2.texOffs(0, 0).addBox(0.0F, -4.0F, -2.5F, 0.0F, 7.0F, 6.0F, 0.0F, false);
		...
		t_r10.texOffs(0, 35).addBox(-2.5F, 2.0F, 0.5F, 3.0F, 3.0F, 0.0F, 0.0F, false);
		...
		t_r11.texOffs(0, 35).addBox(-2.5F, 2.0F, -0.1F, 3.0F, 3.0F, 0.0F, 0.0F, false);
		...
		t_r12.texOffs(0, 35).addBox(-2.5F, 2.0F, 0.0F, 3.0F, 3.0F, 0.0F, 0.0F, false);
		...
		t_r13.texOffs(0, 35).addBox(-2.5F, 2.0F, -0.5F, 3.0F, 3.0F, 0.0F, 0.0F, false);
		...
		t_r14.texOffs(43, 30).addBox(-8.0F, 5.5F, 0.0F, 4.0F, 4.0F, 0.0F, 0.0F, false);
		...
		t2_r1.texOffs(0, 35).addBox(0.0F, -1.0F, 0.5F, 3.0F, 3.0F, 0.0F, 0.0F, false);
		...
		t3_r1.texOffs(0, 35).addBox(-1.0F, 0.0F, 0.5F, 3.0F, 3.0F, 0.0F, 0.0F, false);
		...
		t3_r2.texOffs(0, 35).addBox(0.5F, -1.5F, 0.5F, 3.0F, 3.0F, 0.0F, 0.0F, false);
		...
		t_r15.texOffs(43, 30).addBox(-8.0F, 5.5F, 0.0F, 4.0F, 4.0F, 0.0F, 0.0F, false);

		ModelRenderer bottomHinge1 = new ModelRenderer(this);
		bottomHinge1.setPos(3.0F, 0.0F, 0.0F);
		base.addChild(bottomHinge1);
		bottomHinge1.texOffs(7, 35).addBox(-1.0F, 0.0F, -0.9F, 2.0F, 2.0F, 1.0F, 0.0F, true);

		ModelRenderer bottomHinge2 = new ModelRenderer(this);
		bottomHinge2.setPos(-3.0F, 1.0F, 0.0F);
		base.addChild(bottomHinge2);
		bottomHinge2.texOffs(7, 35).addBox(-1.0F, -1.0F, -0.9F, 2.0F, 2.0F, 1.0F, 0.0F, false);

		latch = new ModelRenderer(this);
		latch.setPos(0.0F, 4.0F, -13.0F);
		base.addChild(latch);
		latch.texOffs(0, 30).addBox(-2.0F, -6.0F, -1.2F, 4.0F, 3.0F, 1.0F, 0.0F, false);
		latch.texOffs(43, 25).addBox(-2.0F, -3.0F, -1.2F, 4.0F, 3.0F, 1.0F, 0.0F, false);
