...
import mod.gottsch.forge.treasure2.core.gui.model.entity.WoodChestMimicModel;
import mod.gottsch.forge.treasure2.core.gui.render.entity.layer.WoodChestMimicLayer;
...
public class WoodChestMimicRenderer extends MobRenderer<WoodChestMimic, WoodChestMimicModel<WoodChestMimic>> {
	 ...
	 * @param context
	 */
	public WoodChestMimicRenderer(EntityRendererManager context, float shadowSize) {
        super(context, new WoodChestMimicModel<>(), 0.5F);
        this.addLayer(new WoodChestMimicLayer<>(this));
        this.scale = 1.0F;
	}

	@Override
	protected void scale(WoodChestMimic mimic, MatrixStack pose, float scale) {
