...
import mod.gottsch.forge.treasure2.core.gui.render.entity.layer.MoldyCrateChestMimicLayer;
...
public class MoldyCrateChestMimicRenderer extends MobRenderer<MoldyCrateChestMimic, MoldyCrateChestMimicModel<MoldyCrateChestMimic>> {
	 ...
	 * @param context
	 */
	public MoldyCrateChestMimicRenderer(EntityRendererManager context, float shadowSize) {
        super(context, new MoldyCrateChestMimicModel<>(), shadowSize);
        this.addLayer(new MoldyCrateChestMimicLayer<>(this));
        this.scale = 1.0F;
	}

	@Override
	protected void scale(MoldyCrateChestMimic mimic, MatrixStack pose, float scale) {
