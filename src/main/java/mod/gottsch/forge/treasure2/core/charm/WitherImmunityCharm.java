 ...
 *
 */
public class WitherImmunityCharm extends Charm {
	public static final String WITHER_IMMUNITY_TYPE = "wither_immunity";
	 ...
	 * @param builder
	 */
	WitherImmunityCharm(Builder builder) {
		super(builder);
	}
	...
	public ITextComponent getCharmDesc(ICharmEntity entity) {
		return new TranslationTextComponent("tooltip.charm.rate.wither_immunity");
	}
	
	public static class Builder extends Charm.Builder {

		public Builder(Integer level) {
			super(ModUtils.asLocation(makeName(WITHER_IMMUNITY_TYPE, level)), WITHER_IMMUNITY_TYPE, level);
		}

		@Override
		public ICharm build() {
			return  new WitherImmunityCharm(this);
		}
	}
}
