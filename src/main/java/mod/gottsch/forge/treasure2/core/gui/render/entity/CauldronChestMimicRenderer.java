...
import mod.gottsch.forge.treasure2.core.gui.render.entity.layer.CauldronChestMimicLayer;
...
public class CauldronChestMimicRenderer extends MobRenderer<CauldronChestMimic, CauldronChestMimicModel<CauldronChestMimic>> {
	 ...
	 * @param context
	 */
	public CauldronChestMimicRenderer(EntityRendererManager context, float shadowSize) {
        super(context, new CauldronChestMimicModel<>(), shadowSize);
        this.addLayer(new CauldronChestMimicLayer<>(this));
        this.scale = 1.0F;
	}

	@Override
	protected void scale(CauldronChestMimic mimic, MatrixStack pose, float scale) {
