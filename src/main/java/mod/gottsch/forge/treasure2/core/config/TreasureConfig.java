...
//				this.commonChestProperties.init();
	...
	public static class KeysAndLocks {
		...
		public ForgeConfigSpec.ConfigValue<Integer> topazKeyMaxUses;
		public ForgeConfigSpec.ConfigValue<Integer> onyxKeyMaxUses;
		...
		KeysAndLocks(final ForgeConfigSpec.Builder builder) {
			...
			topazKeyMaxUses = builder
					...
					.defineInRange("Topaz key max uses:", 7, 1, 32000);
			
			onyxKeyMaxUses = builder
					.comment(" The maximum uses for a given onyx key.")
					.defineInRange("Onyx key max uses:", 7, 1, 32000);
