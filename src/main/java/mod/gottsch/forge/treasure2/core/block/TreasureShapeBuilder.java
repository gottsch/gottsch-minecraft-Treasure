...
public class TreasureShapeBuilder {
	...
	public static VoxelShape[] buildCelestialChest() {
		VoxelShape main = Block.box(0.1, 0, 0.1, 15.9, 9, 15.9);
		VoxelShape zAxisTop = Block.box(0.1, 9, 4.5, 15.9, 15, 11.5);
		VoxelShape xAxisTop = Block.box(4.5, 9, 0.1, 11.5, 15, 15.9);

		VoxelShape zAxisShape = Shapes.or(main, zAxisTop);
		VoxelShape xAxisShape = Shapes.or(main, xAxisTop);
