 ...
 *
 */
public class InfernalChestBlockEntity extends AbstractTreasureChestBlockEntity {

	public InfernalChestBlockEntity(BlockPos pos, BlockState state) {
		super(TreasureBlockEntities.INFERNAL_CHEST.get(), pos, state);
	}
	
    @Override
	public Component getDefaultName() {
		return Component.translatable(LangUtil.screen("infernal_chest.name"));
	}
