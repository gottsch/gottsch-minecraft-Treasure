...
import mod.gottsch.forge.treasure2.core.block.ITreasureChestProxy;
import mod.gottsch.forge.treasure2.core.capability.DurabilityCapabilityProvider;
	...
	public ActionResultType useOn(ItemUseContext context) {
		...
		if (block instanceof AbstractChestBlock) {
			...
			try {
				...
				// TODO One Key crashes here for some reason. OOOOh, maybe because we override the initCap without returning a cap.
