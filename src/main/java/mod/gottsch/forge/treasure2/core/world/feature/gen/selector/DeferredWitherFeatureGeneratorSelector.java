 ...
 *
 */
public class DeferredWitherFeatureGeneratorSelector implements IFeatureGeneratorSelector {

	@Override
	public IFeatureGenerator select() {
		return TreasureFeatureGenerators.DEFERRED_WITHER_FEATURE_GENERATOR;
	}
}
