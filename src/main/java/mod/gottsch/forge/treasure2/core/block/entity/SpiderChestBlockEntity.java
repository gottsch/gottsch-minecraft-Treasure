 ...
 *
 */
public class SpiderChestBlockEntity extends AbstractTreasureChestBlockEntity {
	
	/**
	 * 
	 * @param texture
	 */
	public SpiderChestBlockEntity(BlockPos pos, BlockState state) {
		super(TreasureBlockEntities.SPIDER_CHEST_BLOCK_ENTITY_TYPE.get(), pos, state);
	}
