...
public class SocketsRune extends Rune {
	...
	public boolean isValid(ItemStack itemStack) {		
		return itemStack.getCapability(TreasureCapabilities.CHARMABLE).isPresent() && itemStack.getCapability(TreasureCapabilities.CHARMABLE).map(cap -> cap.isSocketable()).orElse(false);
	}
