...
public class TreasureRunes {
	...
	static {
		RUNE_OF_MANA = new ManaRune.Builder(ModUtils.asLocation("mana_rune"))
				.with($ -> {
					$.lore = "tooltip.runestone.lore.mana_rune";
					$.rarity = Rarity.SCARCE;
					$.getInvalids().add(IlluminationCharm.ILLUMINATION_TYPE);
				}).build();
		register(RUNE_OF_MANA);
		
		RUNE_OF_GREATER_MANA = new GreaterManaRune.Builder(ModUtils.asLocation("greater_mana_rune"))
				.with($ -> {
					$.lore = "tooltip.runestone.lore.greater_mana_rune";
					$.rarity = Rarity.RARE;
					$.getInvalids().add(IlluminationCharm.ILLUMINATION_TYPE);
				}).build();
		register(RUNE_OF_GREATER_MANA);
		
		RUNE_OF_DURABILITY = new DurabilityRune.Builder(ModUtils.asLocation("durability_rune"))
				.with($ -> {
					$.lore = "tooltip.runestone.lore.durability_rune";
					$.rarity = Rarity.SCARCE;
				}).build();
		register(RUNE_OF_DURABILITY);
		
		RUNE_OF_QUALITY = new QualityRune.Builder(ModUtils.asLocation("quality_rune"))
				.with($ -> {
					$.lore = "tooltip.runestone.lore.quality_rune";
					$.rarity = Rarity.RARE;
					$.getInvalids().add(IlluminationCharm.ILLUMINATION_TYPE);
				}).build();
		register(RUNE_OF_QUALITY);
		
		RUNE_OF_EQUIP_AS_MANA = new EquipmentManaRune.Builder(ModUtils.asLocation("equip_mana_rune"))
				.with($ -> {
					$.lore = "tooltip.runestone.lore.equip_mana_rune";
					$.rarity = Rarity.RARE;
				}).build();
		register(RUNE_OF_EQUIP_AS_MANA);
		
		RUNE_OF_ANVIL = new AnvilRune.Builder(ModUtils.asLocation("anvil_rune"))
				.with($ -> {
					$.lore = "tooltip.runestone.lore.anvil_rune";
					$.rarity = Rarity.EPIC;
				}).build();
		register(RUNE_OF_ANVIL);
		
		RUNE_OF_ANGELS = new AngelsRune.Builder(ModUtils.asLocation("angels_rune"))
				.with($ -> {
					$.lore = "tooltip.runestone.lore.angels_rune";
					$.rarity = Rarity.LEGENDARY;
				}).build();
		register(RUNE_OF_ANGELS);
		
		RUNE_OF_PERSISTENCE = new PersistenceRune.Builder(ModUtils.asLocation("persistence_rune"))
				.with($ -> {
					$.lore = "tooltip.runestone.lore.persistence_rune";
					$.rarity = Rarity.EPIC;
				}).build();
		register(RUNE_OF_PERSISTENCE);
		
		RUNE_OF_SOCKETS = new SocketsRune.Builder(ModUtils.asLocation("sockets_rune"))
				.with($ -> {
					$.lore = "tooltip.runestone.lore.sockets_rune";
					$.rarity = Rarity.RARE;
				}).build();
		register(RUNE_OF_SOCKETS);
		
		RUNE_OF_DOUBLE_CHARGE = new DoubleChargeRune.Builder(ModUtils.asLocation("double_charge_rune"))
				.with($ -> {
					$.lore = "tooltip.runestone.lore.double_charge_rune";
