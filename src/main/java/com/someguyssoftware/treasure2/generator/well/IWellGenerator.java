...
public interface IWellGenerator<RESULT extends IGeneratorResult<?>> {
	 ...
	 * @return
	 */
	public abstract RESULT generate(IWorld world, Random random, ICoords spawnCoords, IWellConfig config);
	 ...
	 * @return
	 */
	public abstract RESULT generate(IWorld world, Random random, ICoords originalSpawnCoords,
	 ...
	 * @param coords
	 */
	public default void addDecoration(IWorld world, Random random, ICoords coords) {
...
//				Treasure.logger.debug("Generating blockstate: {}", blockState);
	 ...
	 * @param meta
	 */
	public default IBlockState getDecorationBlockState(IWorld world, Block block) {
	 ...
	 * @return
	 */
	public default IBlockState getRedFlowerBlockState(IWorld world, Random random, Block block) {
	 ...
	 * @return
	 */
	public default IBlockState getMushroomBlockState(IWorld world, Random random, Block block) {
		return block.getDefaultState();
	}
	 ...
	 * @return
	 */
	public default IBlockState getGrassBlockState(IWorld world, Random random, Block block) {
