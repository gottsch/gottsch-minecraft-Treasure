...
// TODO merge poison and wither messages into one MistEffectMessage... that include a data point on the type of effect.
/**
 * 
...
public class WitherMistMessageToServer {
	 ...
	 * @return
	 */
	public static WitherMistMessageToServer decode(PacketBuffer buf) {
