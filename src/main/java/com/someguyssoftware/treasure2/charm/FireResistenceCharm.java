...
public class FireResistenceCharm extends Charm {
	...
	public void appendHoverText(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn, ICharmEntity entity) {
		...
		tooltip.add(new StringTextComponent(" ")
				.append(new TranslationTextComponent("tooltip.charm.rate.fire_resistence", Math.toIntExact(Math.round(this.getMaxPercent() * 100))).withStyle(TextFormatting.GRAY, TextFormatting.ITALIC)));
	}
