 ...
 *
 */
public class WitherResistanceCharm extends Charm {
	public static final String WITHER_RESISTENCE_TYPE = "wither_resistance";
	 ...
	 * @param builder
	 */
	WitherResistanceCharm(Builder builder) {
		super(builder);
	}
	...
	public ITextComponent getCharmDesc(ICharmEntity entity) {
		return new TranslationTextComponent("tooltip.charm.rate.wither_resistance", Math.toIntExact(Math.round(entity.getAmount() * 100)));
	}
	
	public static class Builder extends Charm.Builder {

		public Builder(Integer level) {
			super(ModUtils.asLocation(makeName(WITHER_RESISTENCE_TYPE, level)), WITHER_RESISTENCE_TYPE, level);
		}

		@Override
		public ICharm build() {
			return  new WitherResistanceCharm(this);
		}
	}
}
