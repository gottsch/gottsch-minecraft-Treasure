 ...
 *
 */
public class PoisonResistanceCharm extends Charm {
	public static final String POISON_RESISTENCE_TYPE = "poison_resistance";
	 ...
	 * @param builder
	 */
	PoisonResistanceCharm(Builder builder) {
		super(builder);
	}
	...
	public static class Builder extends Charm.Builder {
		...
		public Builder(Integer level) {
			super(ModUtils.asLocation(makeName(POISON_RESISTENCE_TYPE, level)), POISON_RESISTENCE_TYPE, level);
		}

		@Override
		public ICharm build() {
			return  new PoisonResistanceCharm(this);
		}
	}
}
