...
public class JewelerBenchGui extends GuiContainer implements IContainerListener {
	...
	public static final ResourceLocation TEXTURE = new ResourceLocation(Treasure.MODID,
			"textures/gui/container/jeweler_bench.png");

	@SuppressWarnings("deprecation")
	public static final String LABEL = TextFormatting.BLACK + "" + I18n.translateToLocal("display.jeweler_bench.name");
...
//    private GuiTextField nameField;
	 ...
	 * @param inventory
	 */
	public JewelerBenchGui(InventoryPlayer inventory, World world) {
		super(new JewelerBenchContainer(inventory, world, Minecraft.getMinecraft().player));
		this.playerInventory = inventory;
		this.bench = (JewelerBenchContainer) this.inventorySlots;
