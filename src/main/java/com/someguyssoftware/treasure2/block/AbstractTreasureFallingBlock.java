...
public abstract class AbstractTreasureFallingBlock extends ModFallingBlock implements ITreasureBlock {
	...
	protected static final VoxelShape BOUNDING_SHAPE = Block.makeCuboidShape(0, 0, 0, 16, 16, 16);
	protected static final VoxelShape COLLISION_SHAPE = Block.makeCuboidShape(0, 0, 0, 16, 15.96, 16);
	...
	public void onEntityCollision(BlockState state, World worldIn, BlockPos pos, Entity entityIn) {
		...
		if (!worldIn.isRemote) {
			...
			// set to activated
			worldIn.setBlockState(pos, getDefaultState().with(ACTIVATED, Boolean.valueOf(true)), 3);
		}
	}
